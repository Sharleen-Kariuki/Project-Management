...
class ProjectController extends Controller
{
    ...
    {
        $query = Project::where('company_id', Auth::user()->company_id); // Filter by company_id
    ...
    public function store(StoreProjectRequest $request)
    {
        ...
        if ($image) {
            $data['image_path'] = $image instanceof \Illuminate\Http\UploadedFile
                ? $image->store('project-' . Str::random(), 'public')
                : null;
        } else {
            $data['image'] = null; // Ensure image is set to null if not provided
        }
